...
COPY main.py main-DVR.py DVR_frontend.html config_log.py load_bulk_docs.py load_bulk_docs_categorised.py assistant_rag.py logger.py start_container.sh ./
